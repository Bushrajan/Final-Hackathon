...
// Questions (user)
router.get('/getMy', middlewareToProtect, getMyQuestions);
router.post('/add', middlewareToProtect, addQuestion);
router.put('/update/:questionId', middlewareToProtect, updateQuestion);
router.delete('/delete/:questionId', middlewareToProtect, deleteOwnQuestion);
...
// url/api/user-questions/update/:{id}